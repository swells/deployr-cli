    ...
    after: {
        endpoint: function(details, next) {
            ...
            if (details && details.endpoint) {
                ...
                di.config.set('deployr', details.info);
                di.config.save();
            }
        ...
        about: function(details, next) {
            ...
            //
            // Retrieve server details and store them if not already set
            // 
            if (details && endpoint && !di.config.get('deployr')) {
                di.config.set('deployr', info);
                di.config.save();
            }
