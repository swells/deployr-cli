...
install.example = function(exName, callback) {    
    ...
    function installExample(example) {        
        ...
        function targets(pw) {
            var topics = exConfig.tutorial.topics,
                separator = di.prompt.separator;
            ...
            if (topics) {
                ...
                di.prompt.inquirer([{
                    ...
                    if (answer.topic.method === 'home') {
                       ...
                       exampleChoice(answer.topic.menu, pw);
                    }
                });
            } else {
                run({
        ...
        function exampleChoice(menu, pw) {
            var choices = [],
                separator = di.prompt.separator;
                ...
                .on('close', function(err) {
                    ...
                    di.prompt.inquirer([{
                        ...
                        if (method === 'targets') {
                            ...
                            exampleChoice(optionArgs.menu, optionArgs.pw);
                        } else {
                            di.home();
                        }
                    });
